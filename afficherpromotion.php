...
<head>
  ...
  <!-- Favicons -->
  <link href="js.jpg" rel="icon">
  <link href="js.jpg" rel="apple-touch-icon">
...
<body>
  ...
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b style="color:#AFAFAF;">Immobiliere <span style="color:white;">Jarraya</span></b></a>
      <!--logo end-->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.html#">
                  <div class="task-info">
                    <div class="desc">jarreya Admin Panel</div>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered">
            <a href="profile.html"><img src="js.jpg" class="img-circle" width="80"></a>
          </p>
          <h5 class="centered">Jarreya</h5>
          <li class="mt">
            <a href="index.html">
      ...
      <section class="wrapper">
        ...
        ?>
          ...
          <td class="hidden-phone"><?PHP echo $row['datef']; ?></td>
                    <td>
            <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal" <?PHP $ref= $row['ref'];?>><i class="fa fa-pencil"></i></button>
  ...
  <input type="hidden" value="<?PHP echo $row['ref']; ?>" name="ref">
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Immobiliere Jarraya</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Created with yosr template by <a href="https://templatemag.com/">TemplateMag</a>
        </div>
