...
<head>
  ...
  <!-- Favicons -->
  <link href="img/maki.jpg" rel="icon">
  <link href="img/maki.jpg" rel="apple-touch-icon">
  <!-- Bootstrap core CSS -->
                ...
                <?php
                    ...
                    while( $result = mysql_fetch_object( $requete ) )
                    {
                       echo(
                           ...
                           ." <a href=\"aff2.php?idPersonne=".$result->id."\">modifier</a></div>\n"
                       ) ;
                       echo(
                        "<div align=\"center\">"
                        ." <a href=\"supp1.php?idPersonne=".$result->id."\">supprimer</a></div>\n"
                    ) ;
                    }
                  ?>
            </div>
