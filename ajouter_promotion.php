  ...
  <aside>
    <div id="sidebar" class="nav-collapse ">
      ...
      <ul class="sidebar-menu" id="nav-accordion">
        <p class="centered"><a href="profile.html"><img src="img/sj.jpg" class="img-circle" width="80"></a></p>
          ...
          <div class="form-panel">
            ...
            <form class="form-horizontal style-form" method="post">
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input class=" form-control" id="crefpro" name="refpro" minlength="8" type="text" required />
                </div>
              </div>
              <br>
              <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                  ...
                  <button class="btn btn-theme04" type="Cancel"><a href="index.html">Cancel</a></button>
<?php
...
?>
Produit disponible <br> </br><a href="ajouter_promotion2.php?refpro=<?php echo $refpro?>&amp;nompro=<?php echo $nompro?>&amp;prixpro=<?php echo $prixpro?>"> Ajouter Promotion</a></li>
<?php
}
}
}
