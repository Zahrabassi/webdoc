  ...
  <form method="POST" class="form-horizontal style-form" enctype="multipart/form-data" action="ajoutpromotion.php?id=<?php if (isset($_POST['ajouter'])) {
    ...
    <section id="container">
      ...
      <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="index.html" class="logo"><b style="font-size:22px;">quincaillerie <span>EL YOSR</span></b></a>
        <!--logo end-->
              ...
              <div class="form-panel">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <button class="btn btn-theme04" type="cancel"><a href="Ajouter_promotion.php">Cancel</button>
                  </div>
                </div>
                <?php
                ?>
